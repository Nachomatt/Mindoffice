            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="btn btn-secondary mb-2 my-2"
                       href="{{route('projects.projectmembers.userhours.create',[$project->id,$projectmember->id])}}">Log
                        Hours</a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-light mb-2 my-2"
                       href="{{route('projects.projectmembers.userhours.index',[$project->id,$projectmember->id])}}">See
                        Hours</a>
                </li>
                <li class="nav-item">
                    @can('Moderate Website')
